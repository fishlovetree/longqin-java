  ...
  <div class="app-container">
    ...
    <el-card shadow="never">
      ...
      >
        ...
        <el-table-column label="处理时间" prop="dealTime" width="180" />
...
/** 工作明细 */
function handleDetail(process) {
  router.push({ path: '/completed/details', query: { workId: process.workId, processId: process.processId, 
