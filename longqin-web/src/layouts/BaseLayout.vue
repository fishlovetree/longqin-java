<template>
  ...
  >
          ...
          <lay-menu class="layui-layout-right">
            ...
            <lay-menu-item>
              <lay-dropdown updateAtScroll placement="bottom">
                ...
                <template #content>
                  <lay-dropdown-menu>
                    <lay-dropdown-menu-item @click="toUpdatePwd">
    ...
    <global-password v-model="visiblePassword"></global-password>
  </lay-config-provider>
</template>
...
import GlobalPassword from './global/GlobalPassword.vue'
