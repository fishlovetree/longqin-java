...
public class AutoGenerator {
    ...
    // 项目根目录
    private static final String PROJECT_ROOT_PATH = "E:\\personal\\LongQin-Java\\longqin-system";
    private static final String BASE_PATH = PROJECT_ROOT_PATH + "/src/main/java/com/longqin/system";
    private static final String PARENT_PACKAGE_NAME = "com.longqin.system";
