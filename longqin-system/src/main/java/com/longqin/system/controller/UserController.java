...
public class UserController {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "user", value = "账号实体项", dataType = "User") })
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "账号ID", dataType = "int"),
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "账号ID", dataType = "int"),
			...
			@ApiImplicitParam(name = "confirmPwd", value = "确认新密码", dataType = "String") })
	@ApiResponses({ @ApiResponse(code = 1, message = "修改成功"), @ApiResponse(code = 0, message = "修改失败"),
