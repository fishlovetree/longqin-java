...
public class NoticeController {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "noticeId", value = "公告ID", dataType = "Integer") })
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "title", value = "检索条件：标题", required = false, dataType = "String"), 
		@ApiImplicitParam(name = "beginDate", value = "检索条件：开始时间", required = false, dataType = "String"),
		@ApiImplicitParam(name = "endDate", value = "检索条件：结束时间", required = false, dataType = "String"),
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "notice", value = "公告实体项", dataType = "Notice"),
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "files", value = "附件", dataType = "MultipartFile[]") })
